...
class AdminUserSerializer(serializers.ModelSerializer):
    ...
    def get_clubs_created_count(self, obj: User) -> int:
...
class ClubSerializer(serializers.ModelSerializer):
    ...
    def get_admin_count(self, obj: Club) -> int:
        return obj.memberships.filter(status="active", is_admin=True).count()

    def get_user_membership(self, obj: Club) -> Optional[dict[str, Any]]:
...
class TopicSerializer(serializers.ModelSerializer):
    ...
    def get_created_by_name(self, obj: Topic) -> Optional[str]:
        if obj.created_by:
            return f"{obj.created_by.first_name} {obj.created_by.last_name}"
        return None

    def get_interest_counts(self, obj: Topic) -> dict[str, int]:
        return {
    ...
    def get_user_interest(self, obj: Topic) -> Optional[str]:
...
class TopicInterestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TopicInterest
        fields = ["id", "topic", "user", "user_email", "user_name", "topic_title", "interest_type", "created_at"]
        read_only_fields = ["id", "created_at"]

    def get_user_name(self, obj: TopicInterest) -> str:
        return f"{obj.user.first_name} {obj.user.last_name}"
...
class EventSerializer(serializers.ModelSerializer):
    ...
    def get_host_name(self, obj: Event) -> Optional[str]:
        if obj.host:
            return f"{obj.host.first_name} {obj.host.last_name}"
        return None

    def get_topics(self, obj: Event) -> list[dict[str, Any]]:
    ...
    def get_attendance_count(self, obj: Event) -> int:
...
class EventAttendanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "event", "user", "user_email", "user_name", "event_title", "rsvp_status", "created_at"]
        read_only_fields = ["id", "created_at"]

    def get_user_name(self, obj: EventAttendance) -> str:
        return f"{obj.user.first_name} {obj.user.last_name}"
